      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="flex-1 w-full px-4 md:px-6 lg:px-8 py-4 md:py-6 space-y-4 md:space-y-6 max-w-[1600px] mx-auto">
          ...
          <div className={`relative p-[1px] rounded-2xl bg-gradient-to-b from-purple-500/20 via-purple-500/10 to-purple-500/5 ${mounted ? 'animate-fade-in-up' : 'opacity-0'}`}>
            <div className="rounded-2xl p-5 bg-[#0c0c10]">
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={handleClear}
                  className="group flex items-center gap-2 px-3 py-2.5 glass hover:bg-red-500/10 rounded-xl transition-all border border-white/10 hover:border-red-500/20"
                  title="Clear transcript, detected scriptures, and AI analysis"
                >
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-red-400 transition-colors hidden sm:inline">Clear</span>
                </button>
              </div>
              ...
              {/* Permission Request - Primary action when no permission */}
              {!hasPermission && (
                <button
                  onClick={requestPermission}
                  className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white text-sm font-semibold rounded-xl transition-all shadow-lg shadow-purple-500/20 hover:shadow-purple-500/30 whitespace-nowrap"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                  </svg>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 flex-1">
            ...
            <div className={`relative p-[1px] rounded-2xl bg-gradient-to-b from-purple-500/20 via-purple-500/10 to-purple-500/5 ${mounted ? 'animate-fade-in-up delay-100' : 'opacity-0'}`}>
              <div className="rounded-2xl overflow-hidden flex flex-col min-h-[500px] lg:h-[calc(100vh-280px)] bg-[#0c0c10]">
